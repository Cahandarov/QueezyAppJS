...
export default function QuizItem({
  ...
  return (
    <div className="p-2 sm:p-4 justify-center items-center flex-col rounded-[1.25rem] bg-white border-2 border-solid border-[#EFEEFC] gap-3 lg:gap-8  hover:bg-slate-100 hover:border-transparent transition-colors duration-300">
      ...
      <p className="liveQuizName text-left w-full font-normal sm:font-medium text-xs sm:text-base lg:text-xs xl:text-base font-Romik text-textColorNeutralBlack_0C092A mb-[0.38rem] mt-4 flex overflow-hidden">
        {QuizName}
      </p>
