export default function FriendsItem({ avatar, FullName, country, points }) {
  return (
    <div className="friends flex items-center justify-start gap-2 sm:gap-6">
      <div className="avatarBox flex w-12 h-12 rounded-full border-none items-center justify-start relative">
        ...
        <img
          src={country}
          alt="flag"
          className="friends_flag absolute right-0 bottom-0 -translate-y-2 sm:translate-y-0 -translate-x-1 sm:translate-x-2 rounded-sm w-4 h-3 sm:w-[1.33rem] sm:h-[1rem]"
        />
      </div>
